...
### 🎯 Featured Project: Fiona Fan Site
- **What I Did**: Through the use of p5.js, I was able to create a fansite that has a 3D gallery, a game, and an About Fiona page.
- **Tools**: GitHub, p5.js
- **Result**: A 3-page website with clear story-telling
If you're curious, feel free to learn about it! [Fiona Fan Site](https://github.com/ggesell17/Fiona-Fan-Site/tree/main)
